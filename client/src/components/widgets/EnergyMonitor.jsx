...
const EnergyMonitor = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-100 to-orange-300 dark:bg-gradient-to-br dark:from-gray-600 dark:to-gray-400  p-6 rounded-lg shadow-lg flex flex-col items-center space-y-6 text-gray-800 dark:text-gray-100 transition-transform transform hover:scale-105  h-full">
